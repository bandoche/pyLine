...
service Line {
	...
	loginWithIdentityCredentialForCertificateResult2 loginWithIdentityCredentialForCertificate2(1:string cr1, 2:string cr2, 3:bool flag1, 4:string ip, 5:string comname, 6: i32 val1 7:string cr5)
}
